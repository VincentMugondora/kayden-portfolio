...
const Home = () => {
  return (
    <section className="min-h-screen w-full bg-gradient-to-br from-[#eafff4] via-[#d2f7e9] to-[#eafff4] flex flex-col font-poppins relative overflow-x-hidden">
      {/* Main Content */}
      <div className="flex flex-col md:flex-row w-full flex-1 items-center md:items-start justify-center md:justify-between px-4 md:px-20 pt-8 md:pt-24 pb-8 md:pb-0 relative">
        ...
        <div className="flex-1 flex flex-col justify-center items-center md:items-start z-10">
          ...
          <div className="flex flex-wrap gap-8 font-serif font-semibold text-base md:text-lg text-black justify-center md:justify-start mb-8">
            <a href="#" className="flex items-center gap-1 hover:underline">Resume <span className="inline-block -rotate-45">↗</span></a>
            <a href="#" className="flex items-center gap-1 hover:underline">Linkedin <span className="inline-block -rotate-45">↗</span></a>
            <a href="#" className="flex items-center gap-1 hover:underline">Behance <span className="inline-block -rotate-45">↗</span></a>
          </div>
        </div>
        {/* Right/Emoji Arch */}
        <div className="flex-1 flex justify-center md:justify-end items-center relative mt-10 md:mt-0 z-10">
          ...
          {/* Scroll Indicator */}
          <span className="absolute right-[-32px] bottom-8 md:bottom-0 text-base text-black tracking-widest font-serif font-semibold rotate-90" style={{letterSpacing:'0.2em'}}>SCROLL <span aria-hidden>↗</span></span>
        </div>
      </div>
    </section>
  );
